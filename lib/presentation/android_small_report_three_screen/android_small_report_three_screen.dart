import '../android_small_report_three_screen/widgets/slidertwentyeight_item_widget.dart';
...
class AndroidSmallReportThreeScreen
    extends GetWidget<AndroidSmallReportThreeController> {
  @override
                                              ...
                                              child: Obx(() =>
                                                  CarouselSlider.builder(
                                                      ...
                                                      itemCount: controller
                                                          .androidSmallReportThreeModelObj
                                                          .value
                                                          .slidertwentyeightItemList
                                                          .length,
                                                      itemBuilder: (context,
                                                          index, realIndex) {
                                                        SlidertwentyeightItemModel
                                                            model = controller
                                                                .androidSmallReportThreeModelObj
                                                                .value
                                                                .slidertwentyeightItemList[index];
                                                        return SlidertwentyeightItemWidget(
                                                            model,
  ...
  onTapColumntwentyeight() {
    Get.toNamed(AppRoutes.androidSmallReportTwoScreen);
  }
